// ---------------------------------------------------------------------------
//  ClockPopup.qml  --  el calendario del reloj. Rueda: mes anterior /
//  siguiente; clic en el titulo: volver a hoy.
// ---------------------------------------------------------------------------
import QtQuick
...
Column {
    ...
    Item {
        ...
        Text {
            ...
            text: cal.capitalizar(cal.loc.toString(cal.fecha, "MMMM yyyy"))
